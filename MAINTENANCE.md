...
This repository is the public runtime distribution of the accepted v0.4.1 skill. It does not
...
The v0.4.1 runtime and provenance binding are immutable. Any change to `SKILL.md`,
...
The public v0.4.1 core is derived from the signed private v0.4.1 runtime. Fifteen files remain
...
permitted v0.4.1 public sanitization and is bound in provenance. Any additional runtime difference
